    ...
    <div className="w-11/12 max-sm:w-full mx-auto bg-transparent shadow-lg  overflow-hidden padding  text-night">
      ...
      <div className="my-5 text-lg max-md:text-base ">
        ...
        <div className='flex-1'>
         <strong className='text-lg font-bold  xl:headline'>Description :</strong> <p className=" px-6  text-left font-semibold "> {club.description}</p>

        </div>
         </div>
        <p className=" p-5 px-10 border-2 border-customBlue mx-4"><strong className='text-night text-lg'>Adresse:</strong> {club.adresse}</p>
        { club.téléphone ?
        <p className=" p-5 px-10 border-2 border-customBlue mx-4"><strong className='text-night text-lg'>Téléphone:</strong> {club.téléphone}</p>
        :""}
        {club.prix ? 
        <p className=" p-5 px-10 border-2 border-customBlue mx-4"><strong className='text-night text-lg'>Prix:</strong> {club.prix}</p> 
        :""
        }
        {club.horaires ? 
        <p className=" p-5 px-10 border-2 border-customBlue mx-4"><strong className='text-night text-lg'>Horaires:</strong> {club.horaires}</p>
        :""}
        {club.informations_importants.notes? 
         <p className='p-5 px-10 border-2 border-customBlue mx-4 '><strong className='text-night text-lg'>Notation  :</strong> {club.informations_importants.notes}</p>
        :""}
        ...
        <div className='bg-Lion text-white text-lg max-md:text-base font-bold px-4 py-3 rounded mx-4'>
          pour réserver appeler le numero : {club.téléphone} ou réserver dans le site ou bien  remplir le formulaire ci-dessous
        </div>
