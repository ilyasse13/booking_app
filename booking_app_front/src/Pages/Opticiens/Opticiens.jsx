          ...
          style={{backgroundImage: `url(${activeImage})`,height:"80vh"}}>
            ...
            <div className="my-5 text-lg max-md:text-base ">
                ...
                <div className=' padding w-full text-night font-sansBody font-semibold'>
                 <strong className='text-lg font-bold  xl:headline'>{t('description_title')}:</strong> <p className=" px-6  text-left  "> {optician.description}</p>
                ...
                {optician.prix ? 
                <p className=" p-5 px-10 border-2 border-customBlue mx-4"><strong className='text-night text-lg'>{t('prix')}:</strong> {optician.prix}</p> 
                :""
                }
                {optician.horaires ? 
                <p className=" p-5 px-10 border-2 border-customBlue mx-4"><strong className='text-night text-lg'>{t('Horaires')}:</strong> {optician.horaires}</p>
                :""}
                {optician.informations_importants?
                optician.informations_importants.notes? 
                 <p className='p-5 px-10 border-2 border-customBlue mx-4 '><strong className='text-night text-lg'>{t('Notation')}  :</strong> {optician.informations_importants.notes}</p>
                :"":""}
